    ...
    <Tabs>
      ...
      <TabPane label="支付宝" icon="logo-apple">
        <Row type="flex" justify="center">
          <Col span="4" :lg="5" v-for="item in alipayChannelList" :key="item.channel" class="channel-card-container">
      ...
      <TabPane label="微信" icon="logo-windows">
        <Row type="flex" justify="center" style="margin-top: 10px">
          <Col span="4" :lg="5" v-for="item in wxpayChannelList" :key="item.channel" class="channel-card-container">
            <channel-card v-bind="item" @click.native="selectChannel(item)"/>
          </Col>
        </Row>
      </TabPane>
      ...
      <TabPane label="银联" icon="logo-tux">
        <Row type="flex" justify="center" style="margin-top: 10px">
          <Col span="4" :lg="5" v-for="item in unionpayChannelList" :key="item.channel" class="channel-card-container">
            <channel-card v-bind="item" @click.native="selectChannel(item)"/>
          </Col>
        </Row>
      </TabPane>

...
export const SELECTED_APPID_KEY = 'selectedAppID'
...
export const setAppId = (appId) => {
  Cookies.set(SELECTED_APPID_KEY, appId, { expires: config.cookieExpires || 10 })
}

export const getAppId = () => {
  const appId = Cookies.get(SELECTED_APPID_KEY)
